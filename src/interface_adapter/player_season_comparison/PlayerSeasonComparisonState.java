...
public class PlayerSeasonComparisonState {
    ...
    // Statistic metrics for comparison
    private String gamesPlayedDiff;
    private String pointsDiff;
    private String assistsDiff;
    private String timePlayedDiff; // How much time the player has played (In seconds)
    private String fieldGoalsMadeDiff;
    private String fieldGoalsAttemptedDiff;
    private String freeThrowsMadeDiff;
    private String freeThrowsAttemptedDiff;
    private String threePointsMadeDiff;
    private String threePointsAttemptedDiff;
    private String offensiveReboundsDiff;
    private String defensiveReboundsDiff;
    private String personalFoulsDiff;
    private String stealsDiff;
    private String turnoversDiff;
    private String blocksDiff;
    private String plusMinusDiff;

    // Statistic metrics for per game for stat comparison
    private String pointsPerGameDiff;
    private String assistsPerGameDiff;
    private String timePlayedPerGameDiff; // How much time the player has played (In seconds)
    private String fieldGoalsMadePerGameDiff;
    private String fieldGoalsAttemptedPerGameDiff;
    private String freeThrowsMadePerGameDiff;
    private String freeThrowsAttemptedPerGameDiff;
    private String threePointsMadePerGameDiff;
    private String threePointsAttemptedPerGameDiff;
    private String offensiveReboundsPerGameDiff;
    private String defensiveReboundsPerGameDiff;
    private String reboundsPerGameDiff;
    private String personalFoulsPerGameDiff;
    private String stealsPerGameDiff;
    private String turnoversPerGameDiff;
    private String blocksPerGameDiff;
    private String plusMinusPerGameDiff;

    // Percentage metrics for stat comparison
    private String freeThrowPercentageDiff;
    private String fieldGoalPercentageDiff;
    private String threePointPercentageDiff;

    // instantiate Error fields

    // Statistic metrics error for stat comparison
    private String gamesPlayedDiffError = null;
    private String pointsDiffError = null;
    private String assistsDiffError = null;
    private String timePlayedDiffError = null;
    private String fieldGoalsMadeDiffError = null;
    private String fieldGoalsAttemptedDiffError = null;
    private String freeThrowsMadeDiffError = null;
    private String freeThrowsAttemptedDiffError = null;
    private String threePointsMadeDiffError = null;
    private String threePointsAttemptedDiffError = null;
    private String offensiveReboundsDiffError = null;
    private String defensiveReboundsDiffError = null;
    private String personalFoulsDiffError = null;
    private String stealsDiffError = null;
    private String turnoversDiffError = null;
    private String blocksDiffError = null;
    private String plusMinusDiffError = null;
    ...
    public PlayerSeasonComparisonState(PlayerSeasonComparisonState copy) {
        ...
        gamesPlayedDiff = copy.gamesPlayedDiff;
        pointsDiff = copy.pointsDiff;
        assistsDiff = copy.assistsDiff;
        timePlayedDiff = copy.timePlayedDiff;
        fieldGoalsMadeDiff = copy.fieldGoalsMadeDiff;
        fieldGoalsAttemptedDiff = copy.fieldGoalsAttemptedDiff;
        freeThrowsMadeDiff = copy.freeThrowsMadeDiff;
        freeThrowsAttemptedDiff = copy.freeThrowsAttemptedDiff;
        threePointsMadeDiff = copy.threePointsMadeDiff;
        threePointsAttemptedDiff = copy.threePointsAttemptedDiff;
        offensiveReboundsDiff = copy.offensiveReboundsDiff;
        defensiveReboundsDiff = copy.defensiveReboundsDiff;
        personalFoulsDiff = copy.personalFoulsDiff;
        stealsDiff = copy.stealsDiff;
        turnoversDiff = copy.turnoversDiff;
        blocksDiff = copy.blocksDiff;
        plusMinusDiff = copy.plusMinusDiff;

        // Statistic metrics for per game for stat comparison
        pointsPerGameDiff = copy.pointsPerGameDiff;
        assistsPerGameDiff = copy.assistsPerGameDiff;
        timePlayedPerGameDiff = copy.timePlayedPerGameDiff;
        fieldGoalsMadePerGameDiff = copy.fieldGoalsMadePerGameDiff;
        fieldGoalsAttemptedPerGameDiff = copy.fieldGoalsAttemptedPerGameDiff;
        freeThrowsMadePerGameDiff = copy.freeThrowsMadePerGameDiff;
        freeThrowsAttemptedPerGameDiff = copy.freeThrowsAttemptedPerGameDiff;
        threePointsMadePerGameDiff = copy.threePointsMadePerGameDiff;
        threePointsAttemptedPerGameDiff = copy.threePointsAttemptedPerGameDiff;
        offensiveReboundsPerGameDiff = copy.offensiveReboundsPerGameDiff;
        defensiveReboundsPerGameDiff = copy.defensiveReboundsDiff;
        reboundsPerGameDiff = copy.reboundsPerGameDiff;
        personalFoulsPerGameDiff = copy.personalFoulsPerGameDiff;
        stealsPerGameDiff = copy.stealsPerGameDiff;
        turnoversPerGameDiff = copy.turnoversPerGameDiff;
        blocksPerGameDiff = copy.blocksPerGameDiff;
        plusMinusPerGameDiff = copy.plusMinusPerGameDiff;

        // Percentage metrics for stat comparison
        freeThrowPercentageDiff = copy.freeThrowPercentageDiff;
        fieldGoalPercentageDiff = copy.fieldGoalPercentageDiff;
        threePointPercentageDiff = copy.threePointPercentageDiff;

        // instantiate Error fields

        // Statistic metrics error for stat comparison
        gamesPlayedDiffError = copy.gamesPlayedDiffError;
        pointsDiffError = copy.pointsDiffError;
        assistsDiffError = copy.assistsDiffError;
        timePlayedDiffError = copy.timePlayedDiffError;
        fieldGoalsMadeDiffError = copy.fieldGoalsMadeDiffError;
        fieldGoalsAttemptedDiffError = copy.fieldGoalsAttemptedDiffError;
        freeThrowsMadeDiffError = copy.freeThrowsMadeDiffError;
        freeThrowsAttemptedDiffError = copy.freeThrowsAttemptedDiffError;
        threePointsMadeDiffError = copy.threePointsMadeDiffError;
        threePointsAttemptedDiffError = copy.threePointsAttemptedDiffError;
        offensiveReboundsDiffError = copy.offensiveReboundsDiffError;
        defensiveReboundsDiffError = copy.defensiveReboundsDiffError;
        personalFoulsDiffError = copy.personalFoulsDiffError;
        stealsDiffError = copy.stealsDiffError;
        turnoversDiffError = copy.turnoversDiffError;
        blocksDiffError = copy.blocksDiffError;
        plusMinusDiffError = copy.plusMinusDiffError;
    }
    ...
    public String getGamesPlayedDiff() {
        return gamesPlayedDiff;
    }

    public void setGamesPlayedDiff(String gamesPlayedDiff) {
        this.gamesPlayedDiff = gamesPlayedDiff;
    }
    ...
    public void setAssistsDiff(String assistsDiff) {
        this.assistsDiff = assistsDiff;
    }

    public String getTimePlayedDiff() {
        return timePlayedDiff;
    }

    public void setTimePlayedDiff(String timePlayedDiff) {
        this.timePlayedDiff = timePlayedDiff;
    }

    public String getFieldGoalsMadeDiff() {
        return fieldGoalsMadeDiff;
    }

    public void setFieldGoalsMadeDiff(String fieldGoalsMadeDiff) {
        this.fieldGoalsMadeDiff = fieldGoalsMadeDiff;
    }

    public String getFieldGoalsAttemptedDiff() {
        return fieldGoalsAttemptedDiff;
    }

    public void setFieldGoalsAttemptedDiff(String fieldGoalsAttemptedDiff) {
        this.fieldGoalsAttemptedDiff = fieldGoalsAttemptedDiff;
    }

    public String getFreeThrowsMadeDiff() {
        return freeThrowsMadeDiff;
    }

    public void setFreeThrowsMadeDiff(String freeThrowsMadeDiff) {
        this.freeThrowsMadeDiff = freeThrowsMadeDiff;
    }

    public String getFreeThrowsAttemptedDiff() {
        return freeThrowsAttemptedDiff;
    }

    public void setFreeThrowsAttemptedDiff(String freeThrowsAttemptedDiff) {
        this.freeThrowsAttemptedDiff = freeThrowsAttemptedDiff;
    }

    public String getThreePointsMadeDiff() {
        return threePointsMadeDiff;
    }

    public void setThreePointsMadeDiff(String threePointsMadeDiff) {
        this.threePointsMadeDiff = threePointsMadeDiff;
    }

    public String getThreePointsAttemptedDiff() {
        return threePointsAttemptedDiff;
    }

    public void setThreePointsAttemptedDiff(String threePointsAttemptedDiff) {
        this.threePointsAttemptedDiff = threePointsAttemptedDiff;
    }

    public String getOffensiveReboundsDiff() {
        return offensiveReboundsDiff;
    }

    public void setOffensiveReboundsDiff(String offensiveReboundsDiff) {
        this.offensiveReboundsDiff = offensiveReboundsDiff;
    }

    public String getDefensiveReboundsDiff() {
        return defensiveReboundsDiff;
    }

    public void setDefensiveReboundsDiff(String defensiveReboundsDiff) {
        this.defensiveReboundsDiff = defensiveReboundsDiff;
    }

    public String getPersonalFoulsDiff() {
        return personalFoulsDiff;
    }

    public void setPersonalFoulsDiff(String personalFoulsDiff) {
        this.personalFoulsDiff = personalFoulsDiff;
    }

    public String getStealsDiff() {
        return stealsDiff;
    }

    public void setStealsDiff(String stealsDiff) {
        this.stealsDiff = stealsDiff;
    }

    public String getTurnoversDiff() {
        return turnoversDiff;
    }

    public void setTurnoversDiff(String turnoversDiff) {
        this.turnoversDiff = turnoversDiff;
    }

    public String getBlocksDiff() {
        return blocksDiff;
    }

    public void setBlocksDiff(String blocksDiff) {
        this.blocksDiff = blocksDiff;
    }

    public String getPlusMinusDiff() {
        return plusMinusDiff;
    }

    public void setPlusMinusDiff(String plusMinusDiff) {
        this.plusMinusDiff = plusMinusDiff;
    }

    public String getPointsPerGameDiff() {
        return pointsPerGameDiff;
    }

    public void setPointsPerGameDiff(String pointsPerGameDiff) {
        this.pointsPerGameDiff = pointsPerGameDiff;
    }

    public String getAssistsPerGameDiff() {
        return assistsPerGameDiff;
    }

    public void setAssistsPerGameDiff(String assistsPerGameDiff) {
        this.assistsPerGameDiff = assistsPerGameDiff;
    }

    public String getTimePlayedPerGameDiff() {
        return timePlayedPerGameDiff;
    }

    public void setTimePlayedPerGameDiff(String timePlayedPerGameDiff) {
        this.timePlayedPerGameDiff = timePlayedPerGameDiff;
    }

    public String getFieldGoalsMadePerGameDiff() {
        return fieldGoalsMadePerGameDiff;
    }

    public void setFieldGoalsMadePerGameDiff(String fieldGoalsMadePerGameDiff) {
        this.fieldGoalsMadePerGameDiff = fieldGoalsMadePerGameDiff;
    }

    public String getFieldGoalsAttemptedPerGameDiff() {
        return fieldGoalsAttemptedPerGameDiff;
    }

    public void setFieldGoalsAttemptedPerGameDiff(String fieldGoalsAttemptedPerGameDiff) {
        this.fieldGoalsAttemptedPerGameDiff = fieldGoalsAttemptedPerGameDiff;
    }

    public String getFreeThrowsMadePerGameDiff() {
        return freeThrowsMadePerGameDiff;
    }

    public void setFreeThrowsMadePerGameDiff(String freeThrowsMadePerGameDiff) {
        this.freeThrowsMadePerGameDiff = freeThrowsMadePerGameDiff;
    }

    public String getFreeThrowsAttemptedPerGameDiff() {
        return freeThrowsAttemptedPerGameDiff;
    }

    public void setFreeThrowsAttemptedPerGameDiff(String freeThrowsAttemptedPerGameDiff) {
        this.freeThrowsAttemptedPerGameDiff = freeThrowsAttemptedPerGameDiff;
    }

    public String getThreePointsMadePerGameDiff() {
        return threePointsMadePerGameDiff;
    }

    public void setThreePointsMadePerGameDiff(String threePointsMadePerGameDiff) {
        this.threePointsMadePerGameDiff = threePointsMadePerGameDiff;
    }

    public String getThreePointsAttemptedPerGameDiff() {
        return threePointsAttemptedPerGameDiff;
    }

    public void setThreePointsAttemptedPerGameDiff(String threePointsAttemptedPerGameDiff) {
        this.threePointsAttemptedPerGameDiff = threePointsAttemptedPerGameDiff;
    }

    public String getOffensiveReboundsPerGameDiff() {
        return offensiveReboundsPerGameDiff;
    }

    public void setOffensiveReboundsPerGameDiff(String offensiveReboundsPerGameDiff) {
        this.offensiveReboundsPerGameDiff = offensiveReboundsPerGameDiff;
    }

    public String getDefensiveReboundsPerGameDiff() {
        return defensiveReboundsPerGameDiff;
    }

    public void setDefensiveReboundsPerGameDiff(String defensiveReboundsPerGameDiff) {
        this.defensiveReboundsPerGameDiff = defensiveReboundsPerGameDiff;
    }

    public String getReboundsPerGameDiff() {
        return reboundsPerGameDiff;
    }

    public void setReboundsPerGameDiff(String reboundsPerGameDiff) {
        this.reboundsPerGameDiff = reboundsPerGameDiff;
    }

    public String getPersonalFoulsPerGameDiff() {
        return personalFoulsPerGameDiff;
    }

    public void setPersonalFoulsPerGameDiff(String personalFoulsPerGameDiff) {
        this.personalFoulsPerGameDiff = personalFoulsPerGameDiff;
    }

    public String getStealsPerGameDiff() {
        return stealsPerGameDiff;
    }

    public void setStealsPerGameDiff(String stealsPerGameDiff) {
        this.stealsPerGameDiff = stealsPerGameDiff;
    }

    public String getTurnoversPerGameDiff() {
        return turnoversPerGameDiff;
    }

    public void setTurnoversPerGameDiff(String turnoversPerGameDiff) {
        this.turnoversPerGameDiff = turnoversPerGameDiff;
    }

    public String getBlocksPerGameDiff() {
        return blocksPerGameDiff;
    }

    public void setBlocksPerGameDiff(String blocksPerGameDiff) {
        this.blocksPerGameDiff = blocksPerGameDiff;
    }

    public String getPlusMinusPerGameDiff() {
        return plusMinusPerGameDiff;
    }

    public void setPlusMinusPerGameDiff(String plusMinusPerGameDiff) {
        this.plusMinusPerGameDiff = plusMinusPerGameDiff;
    }

    public String getFreeThrowPercentageDiff() {
        return freeThrowPercentageDiff;
    }

    public void setFreeThrowPercentageDiff(String freeThrowPercentageDiff) {
        this.freeThrowPercentageDiff = freeThrowPercentageDiff;
    }

    public String getFieldGoalPercentageDiff() {
        return fieldGoalPercentageDiff;
    }

    public void setFieldGoalPercentageDiff(String fieldGoalPercentageDiff) {
        this.fieldGoalPercentageDiff = fieldGoalPercentageDiff;
    }

    public String getThreePointPercentageDiff() {
        return threePointPercentageDiff;
    }

    public void setThreePointPercentageDiff(String threePointPercentageDiff) {
        this.threePointPercentageDiff = threePointPercentageDiff;
    }

    public String getGamesPlayedDiffError() {
        return gamesPlayedDiffError;
    }

    public void setGamesPlayedDiffError(String gamesPlayedDiffError) {
        this.gamesPlayedDiffError = gamesPlayedDiffError;
    }

    public String getPointsDiffError() {
        return pointsDiffError;
    }

    public void setPointsDiffError(String pointsDiffError) {
        this.pointsDiffError = pointsDiffError;
    }

    public String getAssistsDiffError() {
        return assistsDiffError;
    }

    public void setAssistsDiffError(String assistsDiffError) {
        this.assistsDiffError = assistsDiffError;
    }

    public String getTimePlayedDiffError() {
        return timePlayedDiffError;
    }

    public void setTimePlayedDiffError(String timePlayedDiffError) {
        this.timePlayedDiffError = timePlayedDiffError;
    }

    public String getFieldGoalsMadeDiffError() {
        return fieldGoalsMadeDiffError;
    }

    public void setFieldGoalsMadeDiffError(String fieldGoalsMadeDiffError) {
        this.fieldGoalsMadeDiffError = fieldGoalsMadeDiffError;
    }

    public String getFieldGoalsAttemptedDiffError() {
        return fieldGoalsAttemptedDiffError;
    }

    public void setFieldGoalsAttemptedDiffError(String fieldGoalsAttemptedDiffError) {
        this.fieldGoalsAttemptedDiffError = fieldGoalsAttemptedDiffError;
    }

    public String getFreeThrowsMadeDiffError() {
        return freeThrowsMadeDiffError;
    }

    public void setFreeThrowsMadeDiffError(String freeThrowsMadeDiffError) {
        this.freeThrowsMadeDiffError = freeThrowsMadeDiffError;
    }

    public String getFreeThrowsAttemptedDiffError() {
        return freeThrowsAttemptedDiffError;
    }

    public void setFreeThrowsAttemptedDiffError(String freeThrowsAttemptedDiffError) {
        this.freeThrowsAttemptedDiffError = freeThrowsAttemptedDiffError;
    }

    public String getThreePointsMadeDiffError() {
        return threePointsMadeDiffError;
    }

    public void setThreePointsMadeDiffError(String threePointsMadeDiffError) {
        this.threePointsMadeDiffError = threePointsMadeDiffError;
    }

    public String getThreePointsAttemptedDiffError() {
        return threePointsAttemptedDiffError;
    }

    public void setThreePointsAttemptedDiffError(String threePointsAttemptedDiffError) {
        this.threePointsAttemptedDiffError = threePointsAttemptedDiffError;
    }

    public String getOffensiveReboundsDiffError() {
        return offensiveReboundsDiffError;
    }

    public void setOffensiveReboundsDiffError(String offensiveReboundsDiffError) {
        this.offensiveReboundsDiffError = offensiveReboundsDiffError;
    }

    public String getDefensiveReboundsDiffError() {
        return defensiveReboundsDiffError;
    }

    public void setDefensiveReboundsDiffError(String defensiveReboundsDiffError) {
        this.defensiveReboundsDiffError = defensiveReboundsDiffError;
    }

    public String getPersonalFoulsDiffError() {
        return personalFoulsDiffError;
    }

    public void setPersonalFoulsDiffError(String personalFoulsDiffError) {
        this.personalFoulsDiffError = personalFoulsDiffError;
    }

    public String getStealsDiffError() {
        return stealsDiffError;
    }

    public void setStealsDiffError(String stealsDiffError) {
        this.stealsDiffError = stealsDiffError;
    }

    public String getTurnoversDiffError() {
        return turnoversDiffError;
    }

    public void setTurnoversDiffError(String turnoversDiffError) {
        this.turnoversDiffError = turnoversDiffError;
    }

    public String getBlocksDiffError() {
        return blocksDiffError;
    }

    public void setBlocksDiffError(String blocksDiffError) {
        this.blocksDiffError = blocksDiffError;
    }

    public String getPlusMinusDiffError() {
        return plusMinusDiffError;
    }

    public void setPlusMinusDiffError(String plusMinusDiffError) {
        this.plusMinusDiffError = plusMinusDiffError;
    }
}
