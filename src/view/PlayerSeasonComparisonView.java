...
public class PlayerSeasonComparisonView extends JPanel implements ActionListener, PropertyChangeListener{
    ...
    public PlayerSeasonComparisonView(PlayerSeasonComparisonController controller,
        ...
        season1.add(season1Dropdown);
        JLabel season2 = new JLabel("Select Season 2: ");
        season2.add(season2Dropdown);
        ...
        compare.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getSource().equals(compare)){
                    ...
                    Object[][] data = {{currentState.getGamesPlayed(), currentState.getPoints(),
                            ...
                            {currentState.getGamesPlayed1(), currentState.getPoints1(),
                            ...
                            {currentState.getGamesPlayedDiff(), currentState.getPointsDiff(),
                                    currentState.getAssistsDiff(), currentState.getTimePlayedDiff(), currentState.getFieldGoalsMadeDiff(),
                                    currentState.getFieldGoalsAttemptedDiff(), currentState.getFreeThrowsMadeDiff(),
                                    currentState.getFreeThrowsAttemptedDiff(), currentState.getThreePointsMadeDiff(),
                                    currentState.getThreePointsAttemptedDiff(), currentState.getOffensiveReboundsDiff(),
                                    currentState.getDefensiveReboundsDiff(), currentState.getPersonalFoulsDiff(), currentState.getStealsDiff(),
                                    currentState.getTurnoversDiff(), currentState.getBlocksDiff(), currentState.getPlusMinusDiff(),
                                    currentState.getPointsPerGameDiff(), currentState.getAssistsPerGameDiff(),
                                    currentState.getTimePlayedPerGameDiff(), currentState.getFieldGoalsMadePerGameDiff(),
                                    currentState.getFieldGoalsAttemptedPerGameDiff(), currentState.getFreeThrowsMadePerGameDiff(),
                                    currentState.getFreeThrowsAttemptedPerGameDiff(), currentState.getThreePointsMadePerGameDiff(),
                                    currentState.getThreePointsAttemptedPerGameDiff(), currentState.getOffensiveReboundsPerGameDiff(),
                                    currentState.getDefensiveReboundsPerGameDiff(), currentState.getReboundsPerGameDiff(),
                                    currentState.getPersonalFoulsPerGameDiff(), currentState.getStealsPerGameDiff(),
                                    currentState.getTurnoversPerGameDiff(), currentState.getBlocksPerGameDiff(),
                                    currentState.getPlusMinusPerGameDiff(), currentState.getFreeThrowPercentageDiff(),
                                    currentState.getFieldGoalPercentageDiff(), currentState.getThreePointPercentageDiff()}
                    };
    ...
    private void showPopup(Object[][] data, String[] columnNames) {
        ...
        JPanel contentPanel = new JPanel(new GridLayout(3, 37));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
        PlayerSeasonComparisonState state = (PlayerSeasonComparisonState) evt.getNewValue();
